...
const faqs = [
  ...
  },
  {
    ...
    answer: "Да, мы предлагаем 3 размера плёнки, которые подходят для большинства легковых автомобилей и кроссоверов.",
  },
  {
  ...
  },
  {
    ...
    answer: "Плёнка предназначена для одноразового использования. После снятия рекомендуется утилизировать её и использовать новую для следующей поездки.",
  },
  {
